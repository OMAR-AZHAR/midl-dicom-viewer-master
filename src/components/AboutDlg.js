...
const AboutDlg = ({ onClose }) => {
    ...
    const urlRepository = "https://github.com/midl/midl-dicom-viewer/"
    ...
    const linkRepository = (
        <Typography variant='body2'>
            <Link 
                ...
                style={{ color: '#999999' }}
            >
                https://github.com/midl/midl-dicom-viewer
            </Link>
        </Typography>
    )
        ...
        <Dialog onClose={onClose} open={true}>
            <DialogTitle onClose={onClose} disableTypography={true}>
                <Typography variant='h6'>
                    About <strong>MIDL</strong> <strong>D</strong>ICOM <strong>V</strong>IEWER
                </Typography>
            </DialogTitle>
            <DialogContent>
                <List>
